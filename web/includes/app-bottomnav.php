<?php
/**
 * App Shell - Bottom Navigation (Mobile)
...
<nav class="app-bottomnav">
  <a href="index.php" class="bottomnav-item <?php echo $activeTab === 'feed' ? 'active' : ''; ?>" data-tab="feed">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
    </svg>
    <span>Feed</span>
  </a>
  <a href="events.php" class="bottomnav-item <?php echo $activeTab === 'events' ? 'active' : ''; ?>">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <a href="index.php#leaderboard" class="bottomnav-item <?php echo $activeTab === 'leaderboard' ? 'active' : ''; ?>" data-tab="leaderboard">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>
    </svg>
    <span>Ranks</span>
  </a>
  <a href="index.php#markets" class="bottomnav-item <?php echo $activeTab === 'markets' ? 'active' : ''; ?>" data-tab="markets">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
